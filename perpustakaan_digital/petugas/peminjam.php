        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="data/edit_peminjaman.php?IDpeminjaman=<?php echo $d['IDpeminjaman'];?>" class="btn btn-warning text-white">Edit</a>
              <a href="data/delete_peminjam.php?IDpeminjaman=<?php echo $d['IDpeminjaman'];?>" class="btn btn-danger text-white">Delete</a>
            </td>
          </tr>
          <?php
            }
