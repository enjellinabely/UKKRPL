...
<div class="container">
  <div class="row" style="margin-top: 1rem;">
    <div class="col">
      <h2>Data Anggota</h2>
      <a href="data/tambah_anggota.php" class="btn btn-success my-3">Tambah Anggota</a>
    </div>
    <div class="col"></div>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <a href="data/edit_anggota.php?iduser=<?php echo $d['IDuser'];?>" class="btn btn-warning text-white">Edit</a>
