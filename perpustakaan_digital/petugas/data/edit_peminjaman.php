                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="status_peminjaman" value="<?php echo $data['status_peminjaman']; ?>" class="form-control" required aria-describedby="emailHelp" value="<?= $data['status_peminjaman'] ?>">
                                </div>
                            </div>
